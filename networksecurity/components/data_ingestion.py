...
3. Split data as train and test
4. Save in the ingested folder
"""
import sys
import os
import pandas as pd
...
class DataIngestion:
    ...
    def split_data_as_train_test(self, dataframe: pd.DataFrame):
        try:
            ...
            logging.info(
                f"Exited {__name__} method of DataIngestion class"
            )
    ...
    def initiate_data_ingestion(self):
        try:
            ...
            data_ingestion_artifact = DataIngestionArtifact(trained_filepath=self.data_ingestion_config.training_file_path,
